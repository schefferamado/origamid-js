...
// var videoGames = [`psp`, `nintendo`, `xbox`, `ps5`];

// for (let item = 0; item < videoGames.length; item++) {
//   console.log(videoGames[item]);
// }

// var frutas = [`pera`, `maca`, `banana`];

// for (let index = 0; index < frutas.length; index++) {
//   if (frutas[index] === `psera`) {
//     break;
//     //   console.log(`A fruta foi achada`);
//     // } else {
//     //   console.log(`fruta nao achada`);
//     // }
//   }
// }
// var linguagens = [`js`, `java`, `php`, `go`];
...
let winsCopa = [1959, 1962, 1970, 1994, 2002];

// Interaja com a array utilizando um loop, para mostrar
// no console a seguinte mensagem, `O brasil ganhou a copa de ${ano}`

// winsCopa.forEach((item) => {
...
// frutas.forEach((item) => {
//   if (item === `Pera`) {
//     //break; so funciona com arrays tradicionais, pois foreach e uma funcao de ordem superior.
//   }
// });
